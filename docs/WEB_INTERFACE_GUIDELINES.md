...
- **Brand resources from the logo.** [Right-click the nav logo](https://x.com/JohnPhamous/status/1636427186566762346) to surface brand assets for quick access.
...
_Source: [Vercel Web Interface Guidelines](https://vercel.com/design/guidelines) · [GitHub](https://github.com/vercel-labs/web-interface-guidelines)_
